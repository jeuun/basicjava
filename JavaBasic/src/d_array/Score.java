...
public class Score {
	...
	public static void main(String[] args) {
		 ...
		 * 우리반 모두의 Java, Olacle, HTML, JQuery, JSP 점수를 
		 * 50 ~ 100까지 랜덤으로 생성시켜주시고,
		 * 석차순으로 석차, 이름, 과목별 점수, 총점, 평균을 출력해주세요.
		 * 
		 * 석차	이름	  Java	Olacle	HTML	JQuery	JSP 	총점		평균
		 *  1	오동규  100	100		100		100		100	 	100		100
		 *  1	박재욱  100	100		100		100		100	 	100		100
		 *  1	오제민  100	100		100		100		100	 	100		100
		 *  1	전보영  100	100		100		100		100	 	100		100
		 *  1	이정은  100	100		100		100		100	 	100		100
		 *  1	이선욱  100	100		100		100		100	 	100		100     
		 
		
		String[] students = {"오동규","박재욱","오제민","전보영","이정은","이선욱"};
		String[] subjects = {"Java","Olacle","HTML","JQuery","JSP"};
		
		System.out.println("석차 이름  Java	Olacle	HTML	JQuery	JSP 	총점		평균");
		System.out.println("------------------------------------------------------");
		...
		System.out.println("합계 :" + sum[i] + "/평균 : " + avg[i] + "석차");
