...
public class ExceptionHandling {
	...
	public static void main(String[] args) {
		...
		//Exception in thread "main" java.lang.ArithmeticException: / by zero 에러가 발생한 클래스
		//at g_exception.ExceptionHandling.main(ExceptionHandling.java:32) 에러가 발생한 위치 
		} catch(ArithmeticException | IndexOutOfBoundsException e){
			e.printStackTrace(); //예외 메시지를 출력한다. - 예외가 발생 했다는것을 알려주기 위해서 , 실행은 계속 됨
