...
public class Exam06 {
	...
	class MyPoint {
		...
		(1) double getDistance(int x1, int y1) {
	...
	[6-12] 다음 중 오버로딩이 성립하기 위한 조건이 아닌 것은? (모두 고르시오) c, d
		...
		d. 매개변수의 이름이 달라야 한다. // 리턴타입은 오버로딩에 영향을 주지 않는다
	...
	[6-13] 다음 중 아래의 add메서드를 올바르게 오버로딩 한 것은? (모두 고르시오) b, c, d
		...
		b, c, d는 모두 메서드의 이름이 add이고 매개변수의 타입이 다르므로 오버로딩이
	...
	class Exercise6_20
	{
		...
		(1) public static int[] shuffle(int[] arr) {
	...
	class Exercise6_24
	{
		...
		(1) public static int abs(int value) {
