...
public class Exam05 {
	...
	b. int[] arr = {1,2,3,}; 
	c. int[] arr = new int[5];
	d. int[] arr = new int[5]{1,2,3,4,5}; //두번째 []에 숫자를 넣으면 안된다
	e. int arr[5]; //배열을 선언할 때는 배열의 크기를 지정할 수 없다
	f. int[] arr[] = new int[3][];
	...
	class Exercise5_6 {
		...
		for(int i=0;i<coinUnit.length;i++) {	
			(1) System.out.println(coinUnit[i]+"원: "+money/coinUnit[i]);
	...
	**
	...
	class Exercise5_13 {
		public static void main(String args[]) {
			...
			(1) for(int j = 0; j <question.length;j++){
