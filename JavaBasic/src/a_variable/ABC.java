...
//사용하고 싶은 클래스, 데이터, 터리내용 등이 있는 경우 선언을 통해 의사표현을 해야한다.
...
public class ABC {
	...
	public static void main(String[] args) {
	    ...
	    //블럭이 시작되면 Tab(탭) 1칸으로 계층을 표현(계층을 쉽게 표현하기 위해)
		...
		/*
		 * 1.클래스는 변수(데이터)와 매서드 (기능)으로 이루어져 있다.
		 * 2.변수선언을 제외한 모든 문장은 매서드 안에서 작성한다.
		 * 3.선언이란 내가 사용하고자 하는 것이 무엇인지(클래스, 매서드, 변수 등)
