...
public class ArithmeticOperator {
	...
	public static void main(String[] args) {
		...
		//따라서 따라서 연산의 결과도 표현범위가 큰 쪽의 타입이 된다.
		...
		//정수는 0으로 나눌 수 없다.
//		int  g1 = 10 / 0; // 런타임- 실행시 발생하는 에러 발생 (by zero)
		float g2 = 10.0f / 0;
		...
		double round = 50.55;
		System.out.println((int)(round + 0.5)); //51
		System.out.println(Math.round(round)); //51 , 소수점 첫째자리에서 반올림
		//소수점 두째자리에서 반올림 해주세요.
		System.out.println((int)(round * 10 + 0.5)/10f); //50  10f나 10.0(double)모두 가능
		...
		System.out.println((int)z+zz+zzz);
		System.out.println((int)z+zz+zzz/3);
