...
public class UserServiceImpl implements UserService{
	...
	public void join() {
		...
		while(true){
			...
			if(pas){ 
				...
				System.out.println();
				System.out.println("ERROR - 패턴에 일치하지 않습니다. ");
				System.out.println("영문자와 숫자만 허용합니다.");
				System.out.println();
				continue;
			}
			}
	...
	public void userList() {
		...
		// 출력
				...
				System.out.println("==================================================");
				System.out.println("번호 /t ID /t 이름");
				System.out.println();
				for(int i = 0; i < userList.size(); i++){
					UserVO user = userList.get(i);
					System.out.println(i + "/t" + user.getId() + "/t" + user.getPassword()
							+ "/t" + user.getName() + "/t" + user.getEmail() + "/t" + user.getPassword()   
							+ "/t" + user.getAddress() + "/t" + user.getPhonenumber());
				}
					System.out.println("==================================================");
			}
	...
	public void changeUserInfo() {
		...
		{//TODO
			...
			//TODO
			if(p(pass)&&pass.equals(passConfirm))
			{
			...
			if(ph(ans))
			{
				user.setPhonenumber(Integer.parseInt(ans));
